...
import { idlFactory } from './acces.did.js';
export { idlFactory } from './acces.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ACCES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./acces.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the acces canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./acces.did.js")._SERVICE>}
 */
export const acces = createActor(canisterId);
