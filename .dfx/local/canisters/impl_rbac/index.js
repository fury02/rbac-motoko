...
import { idlFactory } from './impl_rbac.did.js';
export { idlFactory } from './impl_rbac.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.IMPL_RBAC_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./impl_rbac.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the impl_rbac canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./impl_rbac.did.js")._SERVICE>}
 */
export const impl_rbac = createActor(canisterId);
