...
export interface ObjectRef { 'name' : string, 'count_ref' : CountRef }
...
export type Result_5 = { 'ok' : Admins } |
  { 'err' : Errors };
export type Result_6 = { 'ok' : ObjectRef } |
  { 'err' : Errors };
...
export interface _SERVICE {
  ...
  'add_admin' : ActorMethod<[User__1], Result_7>,
  ...
  'delete_admin' : ActorMethod<[User__1], Result_7>,
