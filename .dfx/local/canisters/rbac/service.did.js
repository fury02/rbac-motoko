export const idlFactory = ({ IDL }) => {
  ...
  const ObjectRef = IDL.Record({ 'name' : IDL.Text, 'count_ref' : CountRef });
  const Result_6 = IDL.Variant({ 'ok' : ObjectRef, 'err' : Errors });
  ...
  return IDL.Service({
    ...
    'add_admin' : IDL.Func([User__1], [Result_7], []),
    ...
    'delete_admin' : IDL.Func([User__1], [Result_7], []),
