...
export const canisterId = process.env.CONSUMER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./consumer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the consumer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./consumer.did.js")._SERVICE>}
 */
export const consumer = createActor(canisterId);
